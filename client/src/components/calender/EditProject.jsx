...
const EditProject = () => {
  ...
  const handleClose = async () => {
    await fetch(
      `https://coscheduleserver.onrender.com/api/tasks/${projectRefNo}/?email=${email}`,
      {
        method: "PUT",
        headers: {
  ...
  const handleDelte = async () => {
    ...
    // await axios.delete(`https://coscheduleserver.onrender.com/tasks/projectRefNo/?email=${email}`)
    fetch(
      `https://coscheduleserver.onrender.com/api/tasks/${projectRefNo}/?email=${email}`,
      {
        method: "DELETE",
